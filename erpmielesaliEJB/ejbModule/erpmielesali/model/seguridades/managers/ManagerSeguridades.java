package erpmielesali.model.seguridades.managers;
...
import erpmielesali.model.auditoria.managers.ManagerAuditoria;
import erpmielesali.model.core.entities.SegAsignacion;
import erpmielesali.model.core.entities.SegModulo;
import erpmielesali.model.core.entities.SegUsuario;
import erpmielesali.model.core.managers.ManagerDAO;
import erpmielesali.model.core.utils.ModelUtil;
import erpmielesali.model.seguridades.dtos.LoginDTO;
...
public class ManagerSeguridades {
    ...
    public void inicializarDemo() throws Exception {
    	...
    	if(existeAdministrador==false) {
			...
			administrador.setApellidos("Guitarra");
			administrador.setClave("zamy2308");
			administrador.setCorreo("zmguitarrad@mielesali.com");
			administrador.setNombres("Zamia");
			administrador.setCodigo("administrador");
     ...
     * @param la direccionIP La direccion IPV4 del cliente Web
    ...
    public void actualizarUsuario(LoginDTO loginDTO, SegUsuario edicionUsuario) throws Exception {
    	...
    	mAuditoria.mostrarLog(loginDTO,getClass(),"actualizarUsuario","se actualizao al usuario"+usuario.getApellidos());
    }
